...
namespace FantasyCharacterBot
{
    public static class EmojiIndex
    {
        ...
        static EmojiEntry[] emojiIndex = {
            ...
            new EmojiEntry( Emoji.FoodPrepared.Burrito, EmojiFlags.Likes | EmojiFlags.Inventory ),
            ...
            new EmojiEntry( Emoji.FoodPrepared.FrenchFries, EmojiFlags.Likes | EmojiFlags.Inventory ),
            new EmojiEntry( Emoji.FoodPrepared.GreenSalad, EmojiFlags.Likes | EmojiFlags.Inventory ),
            new EmojiEntry( Emoji.FoodPrepared.Hamburger, EmojiFlags.Likes | EmojiFlags.Inventory ),
            new EmojiEntry( Emoji.FoodPrepared.HotDog, EmojiFlags.Likes | EmojiFlags.Inventory ),
            ...
            new EmojiEntry( Emoji.FoodPrepared.Pizza, EmojiFlags.Likes | EmojiFlags.Inventory ),
            new EmojiEntry( Emoji.FoodPrepared.Popcorn, EmojiFlags.Likes | EmojiFlags.Inventory ),
            ...
            new EmojiEntry( Emoji.FoodPrepared.Waffle, EmojiFlags.Likes | EmojiFlags.Inventory ),
